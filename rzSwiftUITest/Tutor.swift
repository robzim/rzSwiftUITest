...
let testData = [
    ...
    Tutor(name: "Rob Zimmelman", headline: "Author and Software Developer", bio: "Avid and well-published author and software developer now specializing in iOS mobile app development in Obj-C and Swift. Rob has published 20 apps in the Apple App Store and has over 30 years of experience."),
